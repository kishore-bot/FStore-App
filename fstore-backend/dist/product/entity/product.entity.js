...
__decorate([
    (0, typeorm_1.Column)({ name: 'noOfRating', type: 'float', default: 0 }),
    __metadata("design:type", Number)
], Product.prototype, "noOfRating", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'thumbnail', type: 'varchar', default: '', nullable: true }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.OneToMany)(() => product_image_entity_1.ProductImages, (images) => images.product),
    __metadata("design:type", Array)
