...
let OrderService = class OrderService {
    constructor(orderRepo, productOrderRepo, bagsService, userService, productService, awsService) {
    ...
    async fetchOrderDetails(user, orderId) {
        const order = await this.orderRepo
            ...
            .getOne();
        const processedProductOrders = await Promise.all(order.productOrders.map(async (productOrder) => {
    ...
    async isProductOrdered(productId, user) {
        const orders = await this.orderRepo
            ...
            .getMany();
        const isOrdered = orders.some((order) => order.productOrders.some((productOrder) => {
